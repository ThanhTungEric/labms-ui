...
import {
  ...
  TextField, Box, Button, Dialog, DialogTitle, DialogContent, DialogActions,
    ...
    <Box sx={{ p: 2 }}>
      <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', mb: 2, flexWrap: 'wrap' }}>
        ...
        >
          ...
          <Box className="hover-text" sx={{ display: 'none' }}>Add</Box>
        </Button>
        ...
        <Button variant="contained" color="primary" sx={{
          ...
          <Box className="hover-text" sx={{ display: 'none' }}>Import</Box>
        </Button>
        ...
        <Button variant="contained" color="primary" sx={{
          ...
          <Box className="hover-text" sx={{ display: 'none' }}>Export</Box>
        </Button>
      </Box>

      {showMoreFilters && (
        <Box sx={{ display: 'flex', gap: 2, mb: 2, flexWrap: 'wrap' }}>
          <TextField label="Lab Name" variant="outlined" value={labNameFilter} onChange={(e) => setLabNameFilter(e.target.value)} />
          <TextField label="Lab Code" variant="outlined" value={labCodeFilter} onChange={(e) => setLabCodeFilter(e.target.value)} />
          <TextField label="Location" variant="outlined" value={locationFilter} onChange={(e) => setLocationFilter(e.target.value)} />
          <TextField label="Faculty" variant="outlined" value={facultyFilter} onChange={(e) => setFacultyFilter(e.target.value)} />
        </Box>
      )}
        ...
        <Table sx={{ minWidth: 650 }} aria-label="labs table">
          ...
          <TableBody>
            ...
            {filteredRows.length === 0 && (
              <TableRow>
                <TableCell colSpan={9} align="center">No matching results.</TableCell>
              </TableRow>
            )}
          </TableBody>
        </Table>
